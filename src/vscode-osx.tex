...
\begin{minipage}[c]{0.25\textwidth}
  \raggedleft
  \colorbox{black}{%
    \parbox{\linewidth}{\centering\vspace{0.4cm}\textcolor{white}{Visual Studio Code (OSX)}\vspace{0.4cm}}%
  }%
\end{minipage}
...
You can install more chat participants through the VS Code Extensions \newline (\inlinecode{Cmd}\hspace{1pt}\inlinecode{Shift}\hspace{1pt}\inlinecode{X}) by searching \inlinecode{tag:chat-participant}. GitHub Copilot for Azure is the \inlinecode{@azure} extension. Chat with it to get help with Azure services, developing for Azure, and Azure DevOps tasks.
\customsectionend
